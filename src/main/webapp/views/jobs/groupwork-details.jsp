                ...
                <li>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../information-user/profile.html">Thông tin cá nhân</a></li>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="../users/user-table.jsp" class="waves-effect"><i class="fa fa-user fa-fw"
                                                                              aria-hidden="true"></i><span class="hide-menu">Thành viên</span></a>
                </li>
                <li>
                    <a href="../roles/role-table.jsp" class="waves-effect"><i class="fa fa-modx fa-fw"
