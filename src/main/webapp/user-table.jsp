                                ...
                                <c:forEach var="user" items="${userModelList}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href=" <%-- <c:url value="/user/delete?user_id=${user.getId()}"/> --%>#" userId="${user.getId()}" class="btn btn-sm btn-danger btn-deleteUser">Xóa</a>
...
<script src="<c:url value="/js/user-table.js" />"  />
<script>
