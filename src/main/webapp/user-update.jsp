            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="<c:url value="/user/update" />" class="form-horizontal form-material" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">User Id</label>
                                    <div class="col-md-12">
                                        <input type="text" hidden="hidden" value="<c:out value="${userDetailModel.getId()}" />" name="user_id" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Full Name</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<c:out value="${userDetailModel.fullname}" />" placeholder="Johnathan Doe" name="fullname" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="password" value="<c:out value="${userDetailModel.password}" />" class="form-control form-control-line" name="password">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="role_id">
                                            <c:forEach var="role" items="${roleList}">
                                                <option value="${role.getId()}" <c:if test="${role.getId() == userDetailModel.getRoleId()}">selected</c:if>>${role.getName()}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
...
<script src="<c:url value="/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js" /> x"></script>
